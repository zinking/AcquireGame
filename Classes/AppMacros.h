...
#define DESIGN_RESOLUTION_960X720    3
#define DESIGN_RESOLUTION_1280X720   4
...
//static Resource mediumResource =  { cocos2d::CCSizeMake(960, 720),   "ipad"   };
static Resource mediumResource =  { cocos2d::CCSizeMake(1280, 720),   "ipad"   };
